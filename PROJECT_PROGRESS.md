...
- [x] Installation des dépendances (Pinia, Router, Tailwind)
- [x] Configuration du Design System "Luxury" (Tailwind)
- [x] Mise en place de l'architecture des dossiers

### 1.2 Configuration Backend (À venir)
